"""
MCP Client with OpenAI Integration over Streamable HTTP
Install: pip install openai aiohttp aiohttp-sse mcp
...
async def main():
    ...
    async with streamablehttp_client(url=SERVER_URL, timeout=TIMEOUT) as (
        read_stream,
        write_stream,
        get_session_id,
    ):
